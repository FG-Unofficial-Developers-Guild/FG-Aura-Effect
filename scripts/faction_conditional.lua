...
function hasFaction(rActor, sFaction, rTarget, nodeEffect)
    ...
    for _, sFactionElement in ipairs(aFactions) do
        ...
        if sFactionElement == 'notself' and ((not bNegate and sTargetNode ~= sNodeEffectSource)
           or (bNegate and sTargetNode == sNodeEffectSource)) then
            bReturn = true
            break
        end
        ...
        if (sFactionElement == 'foe' or sFactionElement == 'friend' or sFactionElement == 'neutral') and
            ((not bNegate and sFactionElement == sTargetFaction) or (bNegate and sFactionElement ~= sTargetFaction)) then
            bReturn = true
            break
        end
